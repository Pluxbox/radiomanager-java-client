...
import com.pluxbox.radiomanager.api.invoker.auth.OAuth;
...
public class ApiClient {
    ...
    private String basePath = "http://radiomanager.pb/api/v2";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://radiomanager.pb/api/v2
