...
public class InlineResponse202 {
  ...
  public InlineResponse202 success(String success) {
  ...
  **/
  ...
  @ApiModelProperty(example = "Successfully done the thing!", value = "Describes whatever has succeeded")
  ...
  * @throws IOException if the JSON Object is invalid with respect to InlineResponse202
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InlineResponse202.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!InlineResponse202.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InlineResponse202` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
