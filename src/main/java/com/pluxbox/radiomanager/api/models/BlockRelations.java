...
public class BlockRelations {
  ...
  * @throws IOException if the JSON Object is invalid with respect to BlockRelations
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BlockRelations.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BlockRelations is not found in the empty JSON string", BlockRelations.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!BlockRelations.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BlockRelations` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BlockRelations.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BlockRelations' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BlockRelations> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BlockRelations.class));

       return (TypeAdapter<T>) new TypeAdapter<BlockRelations>() {
           @Override
           public void write(JsonWriter out, BlockRelations value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BlockRelations read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of BlockRelations given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BlockRelations
  * @throws IOException if the JSON string is invalid with respect to BlockRelations
  */
  public static BlockRelations fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BlockRelations.class);
  }

 /**
  * Convert an instance of BlockRelations to an JSON string
  *
  * @return JSON string
  */
