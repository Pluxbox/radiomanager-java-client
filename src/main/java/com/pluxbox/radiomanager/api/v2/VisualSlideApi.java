...
public class VisualSlideApi {
    ...
    /**
     * Build call for downloadVisualSlide
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getVisualSlideValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        
        com.squareup.okhttp.Call call = getVisualSlideCall(progressListener, progressRequestListener);
        return call;
    ...
    public VisualResult getVisualSlide() throws ApiException {
        ApiResponse<VisualResult> resp = getVisualSlideWithHttpInfo();
        return resp.getData();
    }
    ...
    public ApiResponse<VisualResult> getVisualSlideWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = getVisualSlideValidateBeforeCall(null, null);
     ...
     */
    public com.squareup.okhttp.Call getVisualSlideAsync(final ApiCallback<VisualResult> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getVisualSlideValidateBeforeCall(progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<VisualResult>(){}.getType();
